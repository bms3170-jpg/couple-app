...
function getStageLabel(
  ...
  if (stage === "baby") return "아기";
  if (stage === "child") return "꼬마";
  if (stage === "teen") return "청년";
  return "성년";
}
...
function getAnimalLabel(
  ...
  if (animal === "dog") return "강아지";
  if (animal === "cat") return "고양이";
  if (animal === "penguin") return "펭귄";
  return "레서판다";
}
                ...
                (item) => {
                  ...
                  return (
                    <button
                      ...
                      className={`relative overflow-hidden rounded-[24px] border bg-white p-3 text-left shadow-sm ${
                        selected
